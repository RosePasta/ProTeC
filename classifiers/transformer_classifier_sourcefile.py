        ...
        for i in range(0, 10):
            ...
            for t_i, test_instance in enumerate(test_texts):
                ...
                if predicted_class_id == 1:
                    pred_type = "TB"
                writer.write(model_name+"_"+which_field+"_SF_"+str(iterator)+"\t"+str(i)+"\t"+identifier+"\t"+real_type+"\t"+pred_type+"\n")
                writer.close()
            ...
            print(model_name+"_"+which_field+"_SF_"+str(iterator)+"\t"+str(i), dataset, project, )#correct_pb, '/', all_pb_num, correct_tb, '/', all_tb_num, round(f1_pbr,3), round(f1_tbr,3))
