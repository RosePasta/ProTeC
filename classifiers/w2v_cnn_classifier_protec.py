...
for dataset in datasets:
    ...
    for project in projects:
        ...
        for i in range(0, 10):
            ...
            trained_model.fit(X_bug_train, y_bug_train, epochs=epoch, verbose = verbose, callbacks=callbacks,  validation_data = (XValidation,YValidation) )                
            trained_model = keras.models.load_model("./model/dump_"+executed_file_name)
